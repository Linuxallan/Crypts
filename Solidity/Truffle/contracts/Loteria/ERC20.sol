...
interface IERC20 {
    ...
    // Devuelve true o false si se puede hacer la transferencia de tokens
    function transferirLoteria(address _owner, address _recipient, uint256 _amount) external returns(bool);
...
contract ERC20 is IERC20{
    ...
    function transferirLoteria(address _owner, address _recipient, uint256 _tokens) public override returns(bool){
        ...
        // Notificar al mundo de la operacion: sistema distribuido.
        emit Transfer (_owner, _recipient, _tokens);
